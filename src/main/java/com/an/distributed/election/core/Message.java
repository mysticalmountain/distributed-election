package com.an.distributed.election.core;
...
public abstract class Message {
    ...
    public static class Header {
        ...
        public int length;
        public final int headerLength = 28;
         ...
         * @param length
         */
        public Header(int magic, String command, long serialNo, int length) {
            this.magic = magic;
...
//                stream.read(commandBytes);
                ...
                serialNo = readInt64(payload, 12);
                length = (int) readUint32(payload, 20);
            } catch (Exception e) {
        ...
        public Header(byte[] payload, boolean hasMagic) throws ProtocolException {
            try {
                ...
                command = new String(commandBytes, "US-ASCII").trim();
                serialNo = readInt64(payload, 12);
                length = (int) readUint32(payload, 12 + 4 + 8);
            } catch (Exception e) {
                throw new ProtocolException(e);
            }
        }
        ...
        public byte[] serialize() throws ProtocolException {
            try {
                ...
                uint64ToByteStream(serialNo, stream);
